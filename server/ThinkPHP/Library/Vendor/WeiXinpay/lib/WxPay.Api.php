...
class WxPayApi
{
	...
	{
		$url = WxPayConfig::WXPAY_HTTPS."/pay/unifiedorder";
		//检测必填参数
	...
	{
		$url = WxPayConfig::WXPAY_HTTPS."/pay/orderquery";
		//检测必填参数
	...
	{
		$url = WxPayConfig::WXPAY_HTTPS."/pay/closeorder";
		//检测必填参数
		if(!$inputObj->IsOut_trade_noSet()) {
	...
	{
		$url = WxPayConfig::WXPAY_HTTPS."/secapi/pay/refund";
		//检测必填参数
		if(!$inputObj->IsOut_trade_noSet() && !$inputObj->IsTransaction_idSet()) {
	...
	{
		$url = WxPayConfig::WXPAY_HTTPS."/pay/refundquery";
		//检测必填参数
	...
	{
		$url = WxPayConfig::WXPAY_HTTPS."/pay/downloadbill";
		//检测必填参数
	...
	{
		$url = WxPayConfig::WXPAY_HTTPS."/pay/micropay";
		//检测必填参数
	...
	{
		$url = WxPayConfig::WXPAY_HTTPS."/secapi/pay/reverse";
		//检测必填参数
		if(!$inputObj->IsOut_trade_noSet() && !$inputObj->IsTransaction_idSet()) {
	...
	{
		$url = WxPayConfig::WXPAY_HTTPS."/payitil/report";
		//检测必填参数
	...
	{
		$url = WxPayConfig::WXPAY_HTTPS."/tools/shorturl";
		//检测必填参数
